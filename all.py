...
REAL_BEST='/DATA/DATA1/gyx/huawei_ad/model/ViT/hw_zhenshigan3-class2-3e-2-acc_checkpoint.bin'
POSTPRO_BEST='/DATA/DATA1/gyx/huawei_ad/model/ViT/hw_houqi2-class2_checkpoint.bin'
# ===== 你的规则函数导入 =====
...
def get_rule_mapping(ocr: Optional[PaddleOCR], yolo: Optional[YOLO]):
    ...
    mapping["rule_6"] = {
        "title": "真实感差",
        "needs": set(),
        "fn": lambda img, idx=None: bool(is_realistic_or_postprocessing(REAL_BEST,img))
    }
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_root", type=str, default="/DATA/DATA1/gyx/huawei_ad/data_self", help="根目录（包含 rule_1..rule_10）")
    parser.add_argument("--rules", type=str, default="rule_6", help="只跑指定规则，逗号分隔，例如: rule_1,rule_8；留空=全部")
...
# === 规则 rule_6（真实感差）统计 ===
# 总数: 100 | TP: 40 | FP: 4 | TN: 46 | FN: 10
# Accuracy: 0.8600 | Precision: 0.9091 | Recall: 0.8000 | F1: 0.8511


# === 规则 rule_7（未经后期处理）统计 ===
# 总数: 100 | TP: 36 | FP: 1 | TN: 49 | FN: 14
# Accuracy: 0.8500 | Precision: 0.9730 | Recall: 0.7200 | F1: 0.8276
